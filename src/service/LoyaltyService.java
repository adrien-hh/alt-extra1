...
public class LoyaltyService {
  ...
  public static Map<String, Double> computeLoyaltyPoints(
      List<Map<String, Object>> orders, double loyaltyRatio) {
    ...
    for (Map<String, Object> o : orders) {
      ...
      loyaltyPoints.put(cid, loyaltyPoints.get(cid) + qty * unitPrice * loyaltyRatio);
    }
